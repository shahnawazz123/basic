...
use app\models\InsurancesSearch;
...
class InsuranceController extends Controller
{
    ...
    public function behaviors() {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => \app\helpers\PermissionHelper::getUserPermissibleAction(16),
                        'allow' => true,
                        'roles' => [
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()){
                ...
                Yii::$app->session->setFlash('success', 'Insurances successfully added');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()){
                ...
                Yii::$app->session->setFlash('success', 'Insurances successfully updated');
                return $this->redirect(['index']);
            }else{
    ...
    public function actionDelete($id)
    {
        $model = $this->findModel($id);
                    $model->is_deleted = 1;
            $model->save();
                    Yii::$app->session->setFlash('success', 'Insurances successfully deleted');
        return $this->redirect(['index']);
    }
