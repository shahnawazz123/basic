    ...
    <div class="row">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a id="tab2" href="#tab_2" data-toggle="tab">Category products</a></li>
                <li><a id="tab3" href="#tab_3" data-toggle="tab">Push</a></li>
            </ul>
        </div>
        <br clear="all"/>    
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">    
                ...
                <div class="col-md-6" hidden>
                    <label>Select Type <span class="text text-danger"> *</span></label>
                    <?php //echo Html::activeDropDownList($node, 'type', ['P' => 'Pharmacy', 'T' => 'Test Lab','C'=>'Clinic','D'=>'Doctor'], ['class' => 'form-control select2', 'prompt' => 'Select Type'])?><br>
                    <?php //echo $form->field($node, 'type')->radio(['value'=>'P'])->label('Pharmacy'); ?>
                    <?php //echo $form->field($node, 'type')->radio(['value'=>'C'])->label('Clinic'); ?>
                    <?php //echo $form->field($node, 'type')->radio(['value'=>'D'])->label('Doctor'); ?>
                    <?php //echo $form->field($node, 'type')->radio(['value'=>'T'])->label('Lab Test'); ?>
                </div> 
                <div class="clearfix"></div>
                ...
                <div class="col-md-6">
                    <div class="form-group field-category-icon">
                        <label class="control-label">
                            App Banner in English(960 x 315)
                        </label>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group field-category-icon_ar">
                        <label class="control-label">
                            App Banner in Arabic(960 x 315)
                        </label>
                    </div>
                ...
                <div class="col-md-6">
                    <?php echo $form->field($node, 'hide_category_in_app')->checkbox(); ?>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="tab-pane" id="tab_2">
                <div class="col-md-12">
                    ...
                    $productCategory = \app\models\ProductCategories::find()
                            ...
                            ->all();
                    /*echo $this->render('@app/views/product/load-datatable', [
            ...
            <div class="tab-pane" id="tab_3">
                <div class="col-md-6">
                    <?php echo $form->field($node, 'push_title')->textInput() ?>
                </div>
                <div class="clearfix"></div>
                <div class="col-md-6">
                    <?php echo $form->field($node, 'push_message')->textarea(['rows' => 3]) ?>
                </div>
            </div>
