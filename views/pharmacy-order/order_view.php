                                        ...
                                        'value' => function ($data) {
                                            ...
                                            if ($status_id == 2 || $status_id == 4 || $status_id == 6) {
                                                ...
                                                $content_driver = Html::beginForm('', 'get', ['id' => 'assign-pickup-driver' . $data->pharmacy_order_id]) .
                                                        Html::dropDownList('driver_id', $driverid, \app\helpers\AppHelper::getDriverList(), ['prompt' => 'Select Driver', 'class' => 'form-control select2', 'disabled' => $disabled, 'onchange' => 'order.assignPickupDriver(this.value,' . $data->pharmacy_order_id . ')']) . '<br>' .
