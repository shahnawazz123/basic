...
<div class="brands-form">
    ...
    <div class="row" hidden>
        <div class="col-md-6">
            <?php //$form->field($model, 'commission_percentage')->textInput() ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            echo FileUpload::widget([
                'name' => 'Brands[image]',
                'url' => [
                    'upload/common?attribute=Brands[image]'
                ],
                'options' => [
                    'accept' => 'image/*',
                ],
                ...
                'clientEvents' => [
                    ...
                    'fileuploaddone' => 'function (e, data) {
                                        if(data.result.files.error==""){
                                            ...
                                            $(".field-brands-image_name input[type=hidden]").val(data.result.files.name);
